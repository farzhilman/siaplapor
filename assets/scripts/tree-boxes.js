...
function treeBoxes(urlService, jsonData)
{
	...
	var rectNode = { width : 300, height : 250, textMargin : 5 },
		tooltip = { width : 150, height : 200, textMargin : 5 };
	var i = 0,
		duration = 750,
		root;
	...
	// 1) ******************* Update the nodes *******************
		...
		.append('xhtml').html(function(d) {
					...
					return '<div style="width: '
							...
							+ '<b style="font-size: 11px;">' + d.nodeName + '</b><br><br>'
							// + '<b>NARASI: </b>' + d.name + '<br>'
							+ '<p style="font-size: 16px; font-family: monospace;">' + d.name + '</p>'
							+ '</div>';
					if (d.nodeName == 'PROGRAM')
					return '<div style="width: '
							+ (rectNode.width - rectNode.textMargin * 2) + 'px; height: '
							+ (rectNode.height - rectNode.textMargin * 2) + 'px;" class="node-text wordwrap">'
							+ '<b style="font-size: 11px;">' + d.nodeName + '</b><br><br>'
							// + '<b>NARASI: </b>' + d.name + '<br>'
							+ '<p style="font-size: 11px;">' + d.name + '</p><br><br>'
							+ '<b>INDIKATOR: </b>' + d.version + '<br>'
							+ '[' + d.code + ']'
							+ '</div>';
					if (d.nodeName == '-')
					return '<div style="width: '
							...
							+ (rectNode.height - rectNode.textMargin * 2) + 'px;" class="node-text wordwrap">'
							// + '<b>NARASI: </b>' + d.name + '<br>'
							+ '<p style="font-size: 20px; font-family: monospace; text-align: center;">' + d.name + '</p>'
							+ '</div>';
					if (d.version != '-')
					return '<div style="width: '
							+ (rectNode.width - rectNode.textMargin * 2) + 'px; height: '
					...
					return '<div style="width: '
							...
							+ '<b style="font-size: 11px;">' + d.nodeName + '</b><br><br>'
							// + '<b>NARASI: </b>' + d.name + '<br>'
							+ '<p style="font-size: 11px;">' + d.name + '</p>'
							+ '</div>';
				})
